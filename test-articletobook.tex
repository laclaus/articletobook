...
\renewpagestyle{headings}{
    \sethead[\thepage][][\MakeUppercase{\ifnum\c@secnumdepth>\m@ne\if@mainmatter\@chaptername\ \thebookchapter.\ \fi\fi\bookchaptertitle}]{\MakeUppercase{\ifnum\c@secnumdepth>\z@\if@mainmatter\thesection.\ \fi\fi\sectiontitle}}{}{\thepage}
}
\pagestyle{headings}
\makeatother
\begin{document}
